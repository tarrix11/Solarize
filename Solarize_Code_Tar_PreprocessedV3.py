...
hours1 = range(len(all_years['Averages'].values))
sns.scatterplot(x = year['Hours'],y = all_years['Averages'],data = year,s=4)
...
latitude1 = 52.424
longitude1 = -1.536
date_time1 = datetime.datetime(2019, 6, 5, 12, 0, 0, 0, tzinfo=datetime.timezone.utc)


def get_solar_angles(latitude, longitude, date_time):
    # Calculate solar position
    altitude_deg, azimuth_deg = solar.get_position(latitude, longitude, date_time)

    # Calculate zenith angle
    zenith_deg = 90 - altitude_deg

    return zenith_deg, 180- azimuth_deg

get_solar_angles(latitude1,longitude1,date_time1)
